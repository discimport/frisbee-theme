...
To use these stylesheets, rename the files and frisbee with the name of your theme.
...
frisbee-alpha-default-narrow.css  
...
frisbee-alpha-default-normal.css
...
frisbee-alpha-default-wide.css
